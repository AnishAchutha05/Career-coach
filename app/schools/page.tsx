...
export default function SchoolsPage() {
  return (
    <div className="bg-[#050505] min-h-screen text-white selection:bg-green-500 selection:text-black">
      ...
      {/* --- HERO SECTION --- */}
      <section className="min-h-screen flex flex-col justify-center relative overflow-hidden px-6 pt-32 pb-20">
        <div className="absolute inset-0 bg-[#020202]">
           {/* Energetic Background for Students */}
           <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-green-900/10 blur-[150px] rounded-full" />
        ...
        <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-16 items-center relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-serif leading-[1.1] mb-8">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-200 to-cyan-500">
                Launch.
              </span>
            </h1>
            ...
            <div className="flex gap-4">
               <button className="bg-white text-black px-8 py-4 rounded-full font-bold hover:bg-green-500 hover:text-black transition-all">
                 Partner with Us
               </button>
            </div>
          </motion.div>
          ...
          <motion.div
             ...
             className="relative"
          >
             <div className="p-10 rounded-[2rem] bg-[#0a0a0a] border border-white/10 relative overflow-hidden group">
            ...
            <div className="grid gap-6">
               {modules.map((m, i) => (
                  <motion.div 
                     ...
                     className="group p-8 md:p-12 rounded-3xl bg-black border border-white/5 hover:border-green-500/30 transition-all flex flex-col md:flex-row gap-8 items-center"
                  >
                     ...
                     <div className="shrink-0 w-12 h-12 rounded-full border border-white/10 flex items-center justify-center group-hover:bg-green-500 group-hover:text-black group-hover:border-green-500 transition-all">
                        <ArrowRight size={20} />
                     </div>
                  </motion.div>
               ))}
      ...
      {/* --- CTA --- */}
      <section className="py-32 px-6 bg-[#050505] text-center border-t border-white/5">
         <h2 className="text-4xl md:text-6xl font-serif mb-8">Empower Your Campus</h2>
         <p className="text-gray-400 mb-12 max-w-xl mx-auto">
            We conduct 2-day intensive workshops and semester-long credit courses.
         </p>
