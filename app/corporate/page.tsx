...
export default function CorporatePage() {
  return (
    <div className="bg-[#050505] min-h-screen text-white selection:bg-blue-500 selection:text-white">
      <Navbar />
      ...
      <section className="min-h-screen flex flex-col justify-center relative overflow-hidden px-6 pt-32 pb-20">
        ...
        <div className="absolute inset-0 bg-[#020202]">
           <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-blue-900/10 blur-[150px] rounded-full" />
           <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-indigo-900/10 blur-[150px] rounded-full" />
        ...
        <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-16 items-center relative z-10">
          ...
          <motion.div
             ...
             className="relative"
          >
             <div className="p-8 rounded-[2rem] bg-gradient-to-br from-white/5 to-transparent border border-white/10 backdrop-blur-md">
                <div className="flex justify-between items-end mb-8">
                   <div>
                      <div className="text-gray-500 text-sm uppercase tracking-widest mb-2">Team Velocity</div>
      ...
      {/* --- SECTION 2: THE FRICTION (Problems) --- */}
      <section className="py-32 px-6 bg-black border-y border-white/5">
         <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
               {problems.map((p, i) => (
                  <div key={i} className="p-8 rounded-2xl bg-[#0a0a0a] border border-white/5 hover:border-blue-900/50 transition-colors group">
      ...
      {/* --- SECTION 3: THE BLUEPRINT (Solutions) --- */}
            ...
            <div className="space-y-6">
               {solutions.map((s, i) => (
                  <motion.div 
                     ...
                     className="group flex flex-col md:flex-row items-center p-10 rounded-[2rem] bg-black border border-white/5 hover:border-blue-500/30 transition-all"
                  >
